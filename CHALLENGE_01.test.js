const solution = require("./CHALLENGE_01");

describe("CHALLENGE_01 requires", () => {
  it("Must return a string", () => {
    expect(typeof solution("string")).toBe("string");
  });
  it("should return the times a word appears in a string ", () => {
    expect(solution("keys house HOUSE house keys")).toBe("keys2house3");
  });
  it("should return a count of the same word in the string regardless of case", () => {
    expect(solution("Hello heLLo HeLlO")).toBe("hello3");
  });
  it("should return the CHALLENGE_01 codember result", () => {
    expect(
      solution(
